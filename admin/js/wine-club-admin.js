jQuery(document).ready(function($) {
	$("#membershipShippingMethod").change(function () {
	  var selected_option = $('#membershipShippingMethod').val();

	  if (selected_option == 'flat_rate') {
	    $('#shippingFlatRatePrice').slideDown();
	  }
	  if (selected_option != 'flat_rate') {
	    $("#shippingFlatRatePrice").slideUp();
	  }
	})
});
